...
def load_imagenetc(
    ...
    class TempSet(Dataset):
        ...
        def __getitem__(self, index):
            ...
            return img, label, index  # 为了和cifar100c的代码对齐，他是data,label,path
    ...
    samples = make_custom_dataset(data_folder_path, '/home/yxue/model_fusion_tta/robustbench/data/imagenet_test_image_ids.txt', '/home/yxue/model_fusion_tta/robustbench/data/imagenet_class_to_id_map.json')
    ...
    loader = data.DataLoader(imagenet, batch_size=n_examples, shuffle=shuffle, num_workers=0)
    return loader
